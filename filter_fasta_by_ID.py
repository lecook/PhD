...
# This script takes a multi-sequence fasta file and a list of headers that you want to remove from that file
# Looks for each header in the fasta file and removes them from the output file
